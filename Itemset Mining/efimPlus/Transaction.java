...
public class Transaction {
    ...
    /** the transaction utility of the transaction or projected transaction */
      ...
      */
    public Transaction(int[] items, int[] utilities, int transactionUtility,int PreviousLen) {
    	this.items = items;
        ...
        public Transaction(int[] items, int[] utilities, int transactionUtility,int MaxLen,int PreviousLen) {
    	this.items = items;
    	this.utilities = utilities;
    	this.transactionUtility = transactionUtility;
    	this.offset = 0;
     ...
     */
    public Transaction(Transaction transaction, int offsetE,int MaxLen) {	
	...
	public void removeUnpromisingItems(int[] oldNamesToNewNames) {
    	...
    	for(int j=0; j< items.length;j++) {
    		...
    		if(newName != 0) {
    			...
    			//transactionUtilityMaxLen.put(j, 0);
