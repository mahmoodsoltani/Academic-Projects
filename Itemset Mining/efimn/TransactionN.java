...
public class TransactionN {
	...
	public static int[] tempItems = new int[20000];
	/** a buffer to store utilities of an itemset */
	public static int[] tempUtilities = new int[20000];
    ...
    /** the transaction utility of the transaction or projected transaction */
      ...
      */
    public TransactionN(int[] items, int[] utilities, int transactionUtility) {
    	this.items = items;
    	this.utilities = utilities;
    	this.transactionUtility = transactionUtility;
    	this.offset = 0;
    	this.prefixUtility = 0;
    	this.positivePrefixUtility = 0;
        }
     ...
     */
    public TransactionN(TransactionN transaction, int offsetE) {	
    	...
    	if (utilityE>0)
    		this.positivePrefixUtility=transaction.positivePrefixUtility+utilityE;
    	else
    		this.positivePrefixUtility=transaction.positivePrefixUtility;
